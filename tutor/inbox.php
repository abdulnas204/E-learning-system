...
if(isset($_POST['send'])){
    $mess=$_POST['message'];
    $receiver='Admin';
    $stmt=$conn->query("INSERT INTO tutor_inquiries(sender,receiver,message) VALUES('$_SESSION[tutor]','$receiver','$mess')");
    if($stmt){
    ...
    <div class="row" data-toggle="isotope">
        <div class="col-md-10">
            <div class="panel panel-info" style="border-radius: 6px;">
                ...
                <?php
                $sql=$conn->query("SELECT * FROM tutor_inquiries WHERE reply !='NULL' AND sender='$_SESSION[tutor]'");
