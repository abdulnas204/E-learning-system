                        ...
                        <div class="col-md-8">
                            <div class="panel panel-primary" style="border-radius: 6px;">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <?php
                                    $stmt=$conn->query("SELECT * FROM tutor WHERE email='$_SESSION[tutor]'");
                                    ...
                                    $p_no=$_POST['phone'];
                                        ...
                                        {
                                            move_uploaded_file($imageTmp,"../images/tutors/".$imgFile);
                                            $stmt3=$conn->query("UPDATE tutor SET fname='$f_name', mname='$m_name', lname='$l_name',phone='$p_no',image='$imgFile' WHERE email = '$_SESSION[tutor]' ");
                                            if($stmt3){
                                            ...
                                            <div class="col-md-3">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <img src="../images/tutors/<?php echo $row['image'];?>" style="width: 100%; height: 150px;" alt="Update profile">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="panel panel-primary" style="border-radius: 6px;">
                                ...
                                <form method="post">
                                    ...
                                    if(isset($_POST['update_password'])){
                                        ...
                                        $stmt2=$conn->query("UPDATE login SET password='$pass' WHERE username='$_SESSION[tutor]'");
                                        if($stmt2){
