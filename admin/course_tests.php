...
?>
    ...
    <div class="page-section">
        ...
        <h6 class="text-display-1">Course Tests</h6>
        <div class="row">
            <div class="col-md-5">
                <?php
                if(isset($alert))
                    ...
                    <div class="table-responsive">
                        <table data-toggle="data-table" class="table" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <th><span class=""> Programme</span></th>
                            ...
                            <tbody>
                                <?php
                                $get_test = $conn->query("SELECT * FROM test WHERE course_id != '' ORDER BY time_stamp DESC ");
                                $count = 1;
                                while($test = mysqli_fetch_assoc($get_test))
                                {
                                    $get_course = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM course WHERE course_id = '$test[course_id]' "));
                                    $get_programme = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM programme WHERE prog_id = '$get_course[prog_id]' "));
                                    ?>
                                    <tr>
                                        <td><?php echo $count++;?></td>
                                        <td><?php echo $test['test_name'];?></td>
                                        <td><?php echo $get_programme['prog_name'];?></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-xs btn-primary" href="add_question?c_id=<?php echo $test['test_id'];?>"><span class="fa fa-external-link"></span>Details</a>
                                            </div>
                                        </td>
                                    </tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Questions Limit</label>
