...
if(isset($_GET['t_id']))
{
    ...
    $test =  mysqli_fetch_assoc($conn->query("SELECT * FROM test WHERE topic_id = '$_GET[t_id]' "));
}
if(isset($_GET['c_id']))
{
    /*then get only the topic test*/
    $test =  mysqli_fetch_assoc($conn->query("SELECT * FROM test WHERE course_id = '$_GET[c_id]' "));
}
                            ...
                            <div class="panel-body">
                                <p class="text-body-2">
                                    <b>
                                        ...
                                        <br/>
                                        Below is a guide that could help you through.
                                    </b>
                                    <br>
                                    This information will updated soon. Thank you
                                    <br>
