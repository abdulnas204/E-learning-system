...
$topic_id = $_GET['topic'];
$getTopic = mysqli_fetch_assoc($conn->query("SELECT * FROM course_topic WHERE topic_id = '$topic_id' "));
...
$getCourse = mysqli_fetch_assoc($conn->query("SELECT course_id, course_name FROM course WHERE course_id = (SELECT course_id FROM course_topic WHERE course_topic.topic_id = '$topic_id' ) ")); /*Get course details*/
                        ...
                        <div class="media-body">
                            <div class="page-section">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h1 class="text-display-1 margin-none"><?php echo strtoupper($getCourse['course_name']);?></h1>
                                        <?php
                            ...
                            <div class="page-section">
                                <h2 class="text-headline margin-none">
                                    Topic(s) you'll learn
                                </h2>
                                <p class="text-subhead text-light">Below are topic(s) you registered for.</p>

                                <!--Course Details That Include Topics And Subtopics START-->

                                <?php
                                $get_topics = $conn->query("SELECT * FROM course_topic WHERE course_id = '$getCourse[course_id]' AND topic_id='$topic_id' ORDER BY number ASC ");
                            ...
                            <div class="page-section width-270 width-auto-xs">
                                ...
                                <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated="">
                                    <div class="panel-heading">
                                        <h4 class="text-headline">Topic</h4>
                                    </div>
                                    ...
                                    <div class="panel-body text-center">
                                        <p><a href="" onClick="TEST=window.open('test/instructions?t_id=<?php echo $topic_id;?>','CTI KENYA TEST WINDOW','status=1,width=800,height=600,scrollbars=1');  return false;" class="btn btn-info btn-lg paper-shadow relative" data-z="1" data-hover-z="2">Take Test</a></p>
                                    </div>
                                ...
                                <div class="panel panel-default paper-shadow" data-z="0.5" data-hover-z="1" data-animated="">
                                    ...
                                    <ul class="list-group">
                                        <?php
                                        $other_courses = $conn->query("SELECT * FROM course WHERE prog_id='$prog_id'");
                                        while($otherC = mysqli_fetch_assoc($other_courses))
                                        {
                                            ...
                                            <li class="list-group-item">
                                                <div class="media v-middle">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="all_courses" class="link-text-color"><?php echo strtoupper($otherC['course_name']);?></a>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php
