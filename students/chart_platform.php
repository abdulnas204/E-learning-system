...
<!-- Copied from http://learning.aws.ipv4.ro/html/app-student-messages.html by Cyotek WebCopy 1.3.0.405, Wednesday, February 14, 2018, 3:44:34 PM -->
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-primary navbar-brand-logo navbar-nav-padding-left">
                <a class="svg" href="app-student-dashboard-1.html"><svg viewbox="0 0 106 64" height="100%" width="100%" preserveaspectratio="xMidYMid meet">
        ...
        <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="app-student-dashboard-1.html">Dashboard</a></li>
                        ...
                        <li><a href="billing.php">Edit Billing</a></li>
                        <li class="active"><a href="app-student-messages.html">Messages</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Instructor <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../tutor/app-instructor-dashboard-1.html">Dashboard</a></li>
                        <li><a href="../tutor/my_courses.php">My Courses</a></li>
                        <li><a href="../tutor/app-instructor-course-edit-course.html">Edit Course</a></li>
                        <li><a href="../tutor/app-instructor-earnings.html">Earnings</a></li>
                        <li><a href="../tutor/app-instructor-statement.html">Statement</a></li>
                        <li><a href="../tutor/app-instructor-profile.html">Edit Profile</a></li>
                        <li><a href="../tutor/app-instructor-billing.html">Edit Billing</a></li>
                        <li><a href="../tutor/app-instructor-messages.html">Messages</a></li>
                    </ul>
                </li>
            </ul>
...
<li class="dropdown notifications updates">
    ...
    <ul class="dropdown-menu" role="notification">
        ...
        <li class="media">
            ...
            <div class="media-body">
                <a href="#">Bill</a> posted <a href="#">a comment</a> on Adrian's recent <a href="#">post</a>. <br>
...
<!-- // END notifications -->
    ...
    <div data-scrollable="">
        ...
        <ul class="sidebar-menu">
            <li><a href="app-student-dashboard-1.html"><i class="fa fa-bar-chart-o"></i><span>Dashboard</span></a></li>
            <li class="hasSubmenu">
            ...
            <li class="hasSubmenu">
                ...
                <ul id="account-menu">
                    ...
                    <li><a href="billing.php"><span>Edit Billing</span></a></li>
                </ul>
            </li>
            <li class="active"><a href="app-student-messages.html"><i class="fa fa-comments"></i><span>Messages</span></a></li>
            <li><a href="../login1.php"><i class="fa fa-sign-out"></i><span>Logout</span></a></li>
        </ul>
    </div>
</div>
